...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: u4-THcRWcR5h/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: E_EHgLW19iIV/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: XJZuot18auxk/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon3Icon
          className={classNames(projectcss.all, sty.svg__ssDgv)}
          role={"img"}
        />
      }
      menu={(() => {
      ...
      navMenuItems={(() => {
        ...
        __composite["0"]["path"] = `/projects`;
        __composite["0"]["name"] = "Plans Library";
        __composite["1"]["name"] = "Global Catalog";
        __composite["1"]["routes"] = (() => {
          const __composite = [{ name: null, routes: null }, { name: null }];
          __composite["0"]["name"] = "subitem1";
          __composite["0"]["routes"] = (() => {
            const __composite = [{ name: null }];
            __composite["0"]["name"] = "subsubitem1";
            return __composite;
          })();
          __composite["1"]["name"] = "subitem2";
          return __composite;
        })();
        return __composite;
      })()}
      simpleNavTheme={(() => {
        ...
        __composite["customBgColor"] = "#FFFFFF";
        return __composite;
      })()}
      title={``}
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__mtz1K)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__yTzup)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__clfYl)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__f1DQz)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
